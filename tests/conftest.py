...
from custom_components.google_health_plus.const import DOMAIN, OAUTH_SCOPES
...
def enable_custom_integrations(enable_custom_integrations: None) -> None:
    """Enable custom integrations loaded from this repo."""
...
def mock_setup_entry() -> Generator[AsyncMock]:
    ...
    with patch(
        "custom_components.google_health_plus.async_setup_entry", return_value=True
    ) as mock_setup_entry:
...
def mock_google_health_client() -> Generator[AsyncMock]:
    ...
    with (
        patch(
            "custom_components.google_health_plus.GoogleHealthApi",
            autospec=True,
        ) as mock_client,
        patch(
            "custom_components.google_health_plus.config_flow.GoogleHealthApi",
            new=mock_client,
        ),
    ):
        ...
        empty_result = ListDataPointResult(_ListDataPointsModel(data_points=[]))
        client.heart_rate_variability = AsyncMock()
        client.heart_rate_variability.list.return_value = empty_result
        client.heart_rate_variability.required_read_scopes = measurements_scopes
        client.daily_heart_rate_variability = AsyncMock()
        client.daily_heart_rate_variability.list.return_value = empty_result
        client.oxygen_saturation = AsyncMock()
        client.oxygen_saturation.list.return_value = empty_result
        client.daily_oxygen_saturation = AsyncMock()
        client.daily_oxygen_saturation.list.return_value = empty_result
        client.daily_respiratory_rate = AsyncMock()
        client.daily_respiratory_rate.list.return_value = empty_result
        client.respiratory_rate_sleep_summary = AsyncMock()
        client.respiratory_rate_sleep_summary.list.return_value = empty_result
