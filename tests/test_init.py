...
async def test_setup_and_unload(
    ...
    assert hass.states.get("sensor.google_health_plus_steps") is not None
    assert hass.states.get("sensor.google_health_plus_distance") is not None
    assert hass.states.get("sensor.google_health_plus_weight") is not None
    assert hass.states.get("sensor.google_health_plus_resting_heart_rate") is not None
    assert hass.states.get("sensor.google_health_plus_time_asleep") is not None
    assert hass.states.get("sensor.google_health_plus_time_awake") is not None
    assert hass.states.get("sensor.google_health_plus_water_intake") is not None
    assert hass.states.get("sensor.google_health_plus_calories_consumed") is not None
...
async def test_setup_missing_activity_scope(
    ...
    assert hass.states.get("sensor.google_health_plus_steps") is None
    assert hass.states.get("sensor.google_health_plus_distance") is None
    assert hass.states.get("sensor.google_health_plus_active_calories") is None
    assert hass.states.get("sensor.google_health_plus_total_calories") is None
    assert hass.states.get("sensor.google_health_plus_floors") is None

    assert hass.states.get("sensor.google_health_plus_weight") is not None
    assert hass.states.get("sensor.google_health_plus_resting_heart_rate") is not None
    assert hass.states.get("sensor.google_health_plus_body_fat") is not None
...
async def test_setup_missing_measurements_scope(
    ...
    assert hass.states.get("sensor.google_health_plus_weight") is None
    assert hass.states.get("sensor.google_health_plus_resting_heart_rate") is None
    assert hass.states.get("sensor.google_health_plus_body_fat") is None

    assert hass.states.get("sensor.google_health_plus_steps") is not None
    assert hass.states.get("sensor.google_health_plus_distance") is not None
    assert hass.states.get("sensor.google_health_plus_active_calories") is not None
    assert hass.states.get("sensor.google_health_plus_total_calories") is not None
    assert hass.states.get("sensor.google_health_plus_floors") is not None
...
async def test_setup_missing_sleep_scope(
    ...
    assert hass.states.get("sensor.google_health_plus_time_asleep") is None
    assert hass.states.get("sensor.google_health_plus_time_awake") is None
...
async def test_setup_missing_nutrition_scope(
    ...
    assert hass.states.get("sensor.google_health_plus_water_intake") is None
    assert hass.states.get("sensor.google_health_plus_calories_consumed") is None
...
async def test_setup_oauth_implementation_unavailable(
    ...
    with patch(
        "custom_components.google_health_plus.async_get_config_entry_implementation",
