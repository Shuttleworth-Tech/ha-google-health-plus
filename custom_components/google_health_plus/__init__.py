"""The Google Health Plus integration."""
...
class GoogleHealthData:
    ...
    metrics_coordinator: GoogleHealthMetricsCoordinator | None = None
...
async def async_setup_entry(
    ...
    if all(
        scope in scopes
        for scope in api_client.heart_rate_variability.required_read_scopes
    ):
        metrics_coordinator = GoogleHealthMetricsCoordinator(hass, entry, api_client)
        coordinators.append(metrics_coordinator)
